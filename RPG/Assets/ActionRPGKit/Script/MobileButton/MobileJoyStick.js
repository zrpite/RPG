...
var alignRightScreen : boolean = false;
...
function Start(){
		...
		if(alignRightScreen){
			gui.pixelInset.x = Screen.width - gui.pixelInset.x - gui.pixelInset.width;
		}
		
		originalInset.x = gui.pixelInset.x;
		originalInset.y = gui.pixelInset.y;
		
		//Reset GUI Pixel Inset to original position
		gui.pixelInset.x = originalInset.x;
		gui.pixelInset.y = originalInset.y;
		...
		if(joyBackground){
			...
			if(alignRightScreen){
				var jgui : GUITexture = joyBackground.GetComponent(GUITexture);
				jgui.pixelInset.x = Screen.width - jgui.pixelInset.x - jgui.pixelInset.width;
			}
		}
